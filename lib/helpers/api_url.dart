class ApiUrl {
  ...
  // static const String baseUrl = 'http://localhost/responsi1/public/';
  ...
  static const String createWisata = baseUrl + '/api/pariwisata/destinasi_wisata';

  static String updateWisata(int id) {
    return baseUrl + '/api/pariwisata/destinasi_wisata/' + id.toString() + '/update';
  }
  ...
  static String deleteWisata(int id) {
    return baseUrl + '/api/pariwisata/destinasi_wisata/' + id.toString() + '/delete';
  }
}
